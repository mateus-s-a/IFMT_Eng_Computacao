...
Com base na imagem e no seu objetivo, aqui está a lista de materiais e os requisitos técnicos necessários para a montagem:
...
- **Lâmpada:** Uma lâmpada de LED ou incandescente compatível com a tensão da sua rede elétrica (127V ou 220V).
- **Bocal:** O suporte para a lâmpada (soquete), como o mostrado na imagem.
- **Cabos Elétricos Flexíveis (cobre):**
  - **Bitola:** Recomendado 1,5 mm² para circuitos de iluminação, conforme a NBR 5410.
